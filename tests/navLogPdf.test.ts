...
import { renderNavLogPdf } from '../src/services/export/navLogPdf';
...
function sampleSnapshot(): NavLogExportSnapshot {
  return {
    ...
    aircraft: {
      factorBase: 0.57, fuelBurnLh: 18, fuelBurnLmin: 0.3, unusableFuelL: 2,
    ...
    fuelPlan: {
      routeMinutes: 73, taxiDepartureMinutes: 8, arrivalMinutes: 12, diversionMinutes: 11,
      alternateArrivalMinutes: 12, marginMinutes: null, finalReserveMinutes: 30,
...
describe('nav log PDF renderer', () => {
  it('produces one A4 landscape page', async () => {
    ...
    writeFileSync('/mnt/data/capclair-web13-22-0-navlog-sample.pdf', bytes);
  });
